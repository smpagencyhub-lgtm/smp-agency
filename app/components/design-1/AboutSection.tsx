...
export default function AboutSection() {
  ...
  return (
    <section id="about" className="py-24 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-black via-gray-900/20 to-black relative overflow-hidden">
      {/* Background pattern */}
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 lg:gap-16 items-start mb-20">
          ...
          <div className="flex justify-center items-start lg:-mt-8">
            <motion.div
              initial={{ opacity: 0, scale: 0.8, rotate: -5, filter: 'blur(8px)' }}
          ...
          <div className="lg:pt-8">
            ...
            >
              ...
              >
                <span className="text-sm lg:text-base font-semibold tracking-wider uppercase">Learn More</span>
