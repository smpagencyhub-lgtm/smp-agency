...
export default function ServiceSection() {
  ...
  return (
    <section className="relative overflow-hidden bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-[#1a0000] via-black to-black font-sans">
      ...
      <main className="max-w-6xl mx-auto px-4 pb-24 space-y-32 relative z-10">
        ...
        <section className="relative py-12 flex justify-center items-center">
          ...
          {/* Central Booking Card - Professional Design */}
          <motion.div
              ...
              <div className="flex flex-col items-center gap-4 mb-5">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-sm text-gray-400 leading-relaxed max-w-md mx-auto">
                    A focused one‑to‑one call with our team to review your current
                    performance, answer questions, and outline clear next steps for
                    growth.
                  </p>
                </div>
              </div>
