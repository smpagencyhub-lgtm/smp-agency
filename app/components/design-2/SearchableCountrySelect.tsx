...
export default function SearchableCountrySelect({
  ...
  return (
    <div ref={containerRef} className="relative">
      ...
      {open && (
        <div
          className="absolute z-50 top-full left-0 right-0 mt-1 py-2 bg-neutral-800 border border-neutral-600 rounded-lg shadow-xl max-h-64 flex flex-col"
          role="listbox"
        >
          ...
          <ul className="overflow-y-auto overscroll-contain max-h-48 scrollbar-thin">
            {filtered.length === 0 ? (
