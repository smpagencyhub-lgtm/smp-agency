    ...
    <section className="relative overflow-hidden bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-[#1a0000] via-black to-black py-24 font-sans">
      ...
      <div className="max-w-[1920px] mx-auto relative z-10">
        ...
        <motion.div
          ...
          className="flex flex-row justify-center items-center gap-2 mb-20 px-6"
        >
          {/* "WHO" in Red Box */}
          <motion.div
            whileHover={{ scale: 1.05, skewX: -12 }}
            className="bg-red-600 px-3 py-2 shadow-[0_0_30px_rgba(220,38,38,0.6)] transform -skew-x-6 rounded-md cursor-default"
          >
            <h2 className="text-3xl md:text-6xl font-bold text-white tracking-widest uppercase italic transform skew-x-6r">
              WHO
            </h2>
          </motion.div>
          {/* "WE ARE" Plain Text */}
        ...
        >
          <p className="text-gray-300 leading-relaxed text-base md:text-xl font-light tracking-wide">
            ...
            delivering everything from cutting-edge social media management to
            seamless brand building. Designed to elevate your content,
            supercharge you, and unlock your{" "}
            <span className="text-white font-medium border-b border-red-600">
              full revenue potential
            </span>
            . Let us handle the grind while you focus on building your empire
            and owning your space at the top.
          </p>
        </motion.div>
      </div>
    </section>
