...
export default function Header() {
  ...
  return (
    ...
    >
      {/* Consolidated styles: 
         - pointer-events-auto (so you can click links)
         - bg-neutral-900/20 (Transparent as requested)
         - backdrop-blur-sm (So video is visible)
      */}
      <nav className="pointer-events-auto flex items-center justify-between w-full max-w-5xl px-4 sm:px-6 py-2.5 sm:py-3 bg-neutral-900/20 backdrop-blur-sm border border-neutral-700/30 rounded-full shadow-2xl">
