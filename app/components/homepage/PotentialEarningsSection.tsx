        ...
        >
          ...
          <div className="bg-gray-000 p-6 md:p-8 text-center">
            <button
              ...
              className="bg-theme-brand hover:bg-red-600 text-white text-lg font-bold py-3.5 px-10 rounded-full shadow-[0_0_20px_rgba(220,38,38,0.4)] hover:shadow-[0_0_30px_rgba(220,38,38,0.6)] transition-all duration-300 transform hover:-translate-y-1"
            >
