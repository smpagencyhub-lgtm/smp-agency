      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto py-20">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-8 xl:gap-12 items-center min-h-[70vh] lg:min-h-[80vh]">
          ...
          <div className="flex flex-col items-center lg:items-start space-y-4 lg:space-y-6 order-2 lg:order-1 animate-fade-in-up">
            ...
            {/* Left Image - Oval */}
            <div className="relative w-40 h-56 sm:w-48 sm:h-64 md:w-56 md:h-72 lg:w-64 lg:h-80 mt-4 lg:mt-8 animate-fade-in-up animation-delay-300">
              <div className="absolute inset-0 rounded-[40%] overflow-hidden border-2 border-red-600/30 shadow-2xl shadow-red-600/20 transform hover:scale-110 transition-all duration-500 hover:shadow-red-600/40">
          ...
          <div className="flex flex-col items-center lg:items-end space-y-4 lg:space-y-6 order-3 animate-fade-in-up animation-delay-400">
            ...
            {/* Right Image - Oval */}
            <div className="relative w-40 h-56 sm:w-48 sm:h-64 md:w-56 md:h-72 lg:w-64 lg:h-80 mt-4 lg:mt-8 animate-fade-in-up animation-delay-500">
              <div className="absolute inset-0 rounded-[40%] overflow-hidden border-2 border-red-600/30 shadow-2xl shadow-red-600/20 transform hover:scale-110 transition-all duration-500 hover:shadow-red-600/40">
                <div className="w-full h-full bg-gradient-to-br from-gray-800 via-gray-800 to-gray-900 flex items-center justify-center">
                  <div className="text-center">
                    <div className="w-24 h-32 sm:w-28 sm:h-36 bg-gray-700 rounded-lg mb-2 mx-auto"></div>
        ...
        {/* Bottom CTA Section */}
        <div className="absolute bottom-8 sm:bottom-12 lg:bottom-16 left-1/2 transform -translate-x-1/2 flex flex-col items-center space-y-4 sm:space-y-6 animate-fade-in-up animation-delay-800 z-20">
          {/* Apply Now Button - Circular */}
          <a
            href="#apply"
            className="group relative w-28 h-28 sm:w-32 sm:h-32 md:w-36 md:h-36 flex items-center justify-center rounded-full border-2 border-red-600 hover:border-red-500 transition-all duration-500 hover:scale-115 hover:shadow-xl hover:shadow-red-600/60 bg-black/50 backdrop-blur-sm hover:bg-black/70"
          >
